...
async function createGmailAccount(selenium: any, name: string, yearOfBirth: string, month: string, day: string, email: string, pass: string) {
    let driver;
    try {
        driver = await selenium.openNewProfile('temp', 'https://accounts.google.com/signup/v2/createaccount?biz=false&cc=HU&continue=https%3A%2F%2Fmail.google.com%2Fmail%2Fu%2F0%2F&dsh=S1577913102%3A1699530560475032&emr=1&flowEntry=SignUp&flowName=GlifWebSignIn&followup=https%3A%2F%2Fmail.google.com%2Fmail%2Fu%2F0%2F&ifkv=AVQVeywKBWTvk1kKkHpagI-HYXtBwgilxLQs1IXOjYJeFAJgoIzCnQVT-CdmB8xJm1Da-Scr3qh7gQ&osid=1&service=mail&theme=glif');
